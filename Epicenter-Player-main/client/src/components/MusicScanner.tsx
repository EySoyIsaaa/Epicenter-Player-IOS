  ...
  return (
    <div className="flex flex-col gap-4 w-full">
      ...
      <Button
        ...
        disabled={isScanning || scanProgress.isScanning || !isNativeMusicPlatform}
      ...
      {isNativeMusicPlatform && (
        <p className="text-xs text-center text-muted-foreground">Escaneo nativo activo en {platformName.toUpperCase()}</p>
      )}
          ...
          <div className="flex-1">
            ...
            <p className="text-xs text-blue-600/80 dark:text-blue-400/80 mt-1">
              {t('library.webVersionMessage', { 
                defaultValue: 'El escaneo automático está disponible en las apps nativas Android/iOS. En web usa la importación manual para agregar música.' 
              })}
            </p>
          </div>
        </div>
